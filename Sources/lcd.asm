...
;   Last Modified: Luka Henig & Michael Stober, April 11, 2022
;
;   Usage:
...
next:     ldaa 0,x            ; Get character
          ...
          cmpa #$0            ; To extend the existing string with spaces (padding) to aling left   
          beq sp1 
          bra sp2
sp1:      ldaa #$20           ; #$20 equal space in ASCII 
          dex    
